...
function carregaLinias($connexio, $compra_ID) {
    ...
    $consulta = $connexio->prepare("SELECT PurchaseLine.Quantity as Quantity, PurchaseLine.Total_Price as Total_Price, PurchaseLine.Unit_Price as Unit_Price, Bonsai.Name AS Name
